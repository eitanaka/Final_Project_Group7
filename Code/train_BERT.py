...
if __name__ == "__main__":
    ...
    BATCH_SIZE = 16
    EPOCHS = 3
    TRAIN_DATA_PATH = "/home/ubuntu/NLP/NLP_Final_Project_Group7/Code/squad/train-v2.0.json"
    DEV_DATA_PATH = '/home/ubuntu/NLP/NLP_Final_Project_Group7/Code/squad/dev-v2.0.json'
    MODEL_PATH = "bert-base-uncased"
    MODEL_SAVE_PATH = f"/home/ubuntu/NLP/NLP_Final_Project_Group7/Code/models/{MODEL_PATH}-lr{LEARNING_RATE}-epochs{EPOCHS}-batchsize{BATCH_SIZE}-LORA-retrain/"
    LORA = True
    ...
    train_dataset = SquadDataset(TRAIN_DATA_PATH, tokenizer)

    generator = torch.Generator().manual_seed(42)
    train_dataset, val_dataset = random_split(train_dataset, [0.8, 0.2], generator=generator)

    test_dataset = SquadDataset(DEV_DATA_PATH, tokenizer)
